...
export default function MedalConfirmation() {
    ...
    if (!checkoutRequestId) {
        return (_jsxs("div", { className: `${pageRoot} py-16 px-6`, children: [_jsx("p", { className: "text-center text-fog", children: "Invalid confirmation link." }), _jsx("div", { className: "text-center mt-4", children: _jsx("button", { onClick: () => navigate('/shop?category=Medals'), className: "text-accent", children: "Back to Medals" }) })] }));
    }
    if (gatePrompt) {
    ...
    if (error && !details) {
        return (_jsx("div", { className: `${pageRoot} py-16 px-6`, children: _jsxs("div", { className: "max-w-lg mx-auto bg-red-500/10 border border-red-500/20 p-6 flex gap-4", children: [_jsx(AlertCircle, { className: "text-red-400" }), _jsxs("div", { children: [_jsx("p", { className: "text-red-300 mb-4", children: error }), _jsx("button", { onClick: () => navigate('/shop?category=Medals'), className: "text-accent underline", children: "Back to Medals" })] })] }) }));
    }
    const paid = paymentStatus === 'paid' || details?.payment_status === 'paid';
    const displayEmail = details?.email || email;
    return (_jsxs("div", { className: pageRoot, children: [_jsx("section", { className: "bg-ink light:bg-ink-light border-b border-white/5 light:border-black/8 px-[6%] pt-14 pb-11", children: _jsxs("div", { className: "max-w-2xl mx-auto text-center", children: [paid ? (_jsx(CheckCircle, { className: "w-14 h-14 text-green-400 mx-auto mb-4" })) : (_jsx(Clock, { className: "w-14 h-14 text-yellow-400 mx-auto mb-4" })), _jsx("h1", { className: "font-bebas text-5xl text-chalk light:text-chalk-light", children: paid ? (_jsxs(_Fragment, { children: ["MEDAL ", _jsx("span", { className: "text-accent light:text-accent-light", children: "CONFIRMED" })] })) : (_jsxs(_Fragment, { children: ["PAYMENT ", _jsx("span", { className: "text-yellow-400", children: "PENDING" })] })) }), paid && displayEmail && (_jsxs("p", { className: "text-fog light:text-fog-light text-sm mt-3 max-w-md mx-auto", children: ["A confirmation email with your PDF certificate was sent to", ' ', _jsx("span", { className: "text-chalk light:text-chalk-light", children: displayEmail }), "."] }))] }) }), _jsxs("div", { className: "max-w-2xl mx-auto px-[6%] py-10 pb-20 space-y-6", children: [_jsxs("div", { className: `${cardSurface} p-6`, children: [_jsxs("div", { className: "flex items-start gap-4 mb-6", children: [_jsx(Award, { className: "text-accent light:text-accent-light flex-shrink-0", size: 28 }), _jsxs("div", { children: [_jsx("h2", { className: "font-bebas text-3xl", children: details?.tier_name || state.tierName || 'Medal' }), _jsx("p", { className: "text-fog light:text-fog-light", children: (details?.distance_km ?? state.distanceKm) != null
                                                    ? `${details?.distance_km ?? state.distanceKm} km`
                                                    : '—' })] })] }), _jsxs("dl", { className: "grid grid-cols-2 gap-4 text-sm", children: [_jsxs("div", { children: [_jsx("dt", { className: "text-fog light:text-fog-light uppercase tracking-widest text-xs mb-1", children: "Buyer" }), _jsx("dd", { className: "font-semibold", children: details?.buyer_name || '—' })] }), _jsxs("div", { children: [_jsx("dt", { className: "text-fog light:text-fog-light uppercase tracking-widest text-xs mb-1", children: "Quantity" }), _jsx("dd", { className: "font-semibold", children: details?.quantity ?? state.quantity ?? '—' })] }), _jsxs("div", { children: [_jsx("dt", { className: "text-fog light:text-fog-light uppercase tracking-widest text-xs mb-1", children: "Total" }), _jsxs("dd", { className: "font-bebas text-2xl text-accent light:text-accent-light", children: ["KES", ' ', Number(details?.total_price ?? state.totalPrice ?? 0).toLocaleString()] })] }), _jsxs("div", { children: [_jsx("dt", { className: "text-fog light:text-fog-light uppercase tracking-widest text-xs mb-1", children: "M-Pesa Receipt" }), _jsx("dd", { className: "font-semibold", children: details?.mpesa_receipt || '—' })] })] })] }), paid && details?.purchases && details.purchases.length > 0 && (_jsx("div", { className: "space-y-4", children: details.purchases.map((purchase, index) => (_jsx("div", { className: `${cardSurface} p-5`, children: _jsxs("div", { className: "flex flex-wrap gap-4 items-start justify-between", children: [_jsxs("div", { className: "flex gap-4 items-start", children: [purchase.qr_data_url && (_jsx("img", { src: purchase.qr_data_url, alt: `Medal QR ${purchase.short_code}`, className: "w-28 h-28 bg-white p-1" })), _jsxs("div", { children: [_jsxs("p", { className: "font-barlow-condensed font-bold text-xs tracking-widest uppercase text-accent light:text-accent-light mb-1", children: ["Certificate ", index + 1] }), _jsx("p", { className: "font-bebas text-2xl tracking-wider", children: purchase.short_code }), _jsxs("p", { className: "text-sm text-fog light:text-fog-light mt-1", children: [details.tier_name, " \u00B7 ", details.distance_km, " km"] })] })] }), _jsx(MedalDownloadButton, { purchaseId: purchase.id, paymentStatus: purchase.payment_status, verify: verify, compact: true })] }) }, purchase.id))) })), paid && (_jsx("div", { className: "flex flex-wrap gap-3 items-start", children: _jsx(MedalResendButton, { checkoutRequestId: checkoutRequestId, paymentStatus: "paid", verify: verify }) })), _jsxs("div", { className: "flex flex-wrap gap-3", children: [_jsx(Link, { to: "/shop?category=Medals", className: "bg-accent light:bg-accent-light text-black light:text-white px-6 py-3 font-barlow-condensed font-bold tracking-widest uppercase no-underline clip-angled-sm", children: "Browse Medals" }), _jsx(Link, { to: "/account/medals", className: "border border-white/20 light:border-black/20 px-6 py-3 font-barlow-condensed font-bold tracking-widest uppercase no-underline text-chalk light:text-chalk-light", children: "My Medals" })] })] })] }));
}
