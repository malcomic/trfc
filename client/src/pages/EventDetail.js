...
export default function EventDetail() {
    ...
    return (_jsxs("div", { className: pageRoot, children: [_jsx("section", { className: "bg-ink light:bg-ink-light border-b border-white/5 light:border-black/8 px-[6%] pt-14 pb-8", children: _jsxs("div", { className: "max-w-4xl mx-auto", children: [_jsx("button", { onClick: () => navigate('/events'), className: "text-fire text-sm mb-4 bg-transparent border-0 cursor-pointer font-barlow-condensed font-bold hover:underline", children: "\u2190 Back to Events" }), _jsx("h1", { className: "font-bebas text-5xl leading-tight", children: ev.title })] }) }), _jsxs("div", { className: "max-w-4xl mx-auto px-[6%] py-10 pb-20", children: [_jsx("img", { src: ev.image_url || 'https://images.unsplash.com/photo-1571008887538-b36bb32f4571?w=800&q=80', alt: ev.title, className: "w-full h-80 object-cover brightness-85 clip-angled mb-8" }), _jsx("p", { className: "text-fog light:text-fog-light mb-8 leading-relaxed", children: ev.description }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4 mb-8", children: [_jsxs("div", { className: `${cardSurface} p-5 flex items-start gap-3`, children: [_jsx(MapPin, { size: 18, className: "text-fire flex-shrink-0 mt-0.5" }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-fog light:text-fog-light uppercase letter-spacing-widest mb-1", children: "Location" }), _jsx("p", { className: "font-semibold", children: ev.location })] })] }), _jsxs("div", { className: `${cardSurface} p-5 flex items-start gap-3`, children: [_jsx(Clock, { size: 18, className: "text-fire flex-shrink-0 mt-0.5" }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-fog light:text-fog-light uppercase letter-spacing-widest mb-1", children: "Date & Time" }), _jsx("p", { className: "font-semibold", children: formattedDate }), formattedTime && _jsx("p", { className: "text-fog light:text-fog-light text-sm", children: formattedTime })] })] }), _jsxs("div", { className: `${cardSurface} p-5 flex items-start gap-3`, children: [_jsx(Ticket, { size: 18, className: "text-fire flex-shrink-0 mt-0.5" }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-fog light:text-fog-light uppercase letter-spacing-widest mb-1", children: "Price" }), _jsx("p", { className: "font-bebas text-3xl text-fire", children: isFree ? 'FREE' : `KES ${Number(ev.price).toLocaleString()}` })] })] }), ev.capacity && (_jsxs("div", { className: `${cardSurface} p-5 flex items-start gap-3`, children: [_jsx(Users, { size: 18, className: "text-fire flex-shrink-0 mt-0.5" }), _jsxs("div", { children: [_jsx("p", { className: "text-xs text-fog light:text-fog-light uppercase letter-spacing-widest mb-1", children: "Capacity" }), _jsxs("p", { className: "font-semibold", children: [ev.capacity, " spots"] })] })] }))] }), _jsxs("div", { className: `${cardSurface} p-6`, children: [_jsx("label", { className: "block font-barlow-condensed font-bold text-sm letter-spacing-widest text-transform-uppercase text-fire mb-4", children: "Number of Tickets" }), _jsxs("div", { className: "flex items-center gap-4 mb-6", children: [_jsx("button", { onClick: () => setQuantity(Math.max(1, quantity - 1)), className: `w-10 h-10 flex items-center justify-center hover:bg-fire hover:text-white transition ${inputField}`, children: _jsx(Minus, { size: 16 }) }), _jsx("span", { className: "font-bebas text-3xl w-12 text-center", children: quantity }), _jsx("button", { onClick: () => setQuantity(Math.min(10, quantity + 1)), className: `w-10 h-10 flex items-center justify-center hover:bg-fire hover:text-white transition ${inputField}`, children: _jsx(Plus, { size: 16 }) }), _jsxs("span", { className: "text-fog light:text-fog-light ml-4", children: ["Total: ", _jsx("strong", { className: "text-fire font-bebas text-2xl", children: isFree ? 'FREE' : `KES ${(Number(ev.price) * quantity).toLocaleString()}` })] })] }), _jsxs("button", { onClick: () => navigate(`/events/${id}/checkout`, { state: { quantity } }), className: "w-full bg-fire text-white py-4 font-barlow-condensed font-black text-sm letter-spacing-widest text-transform-uppercase clip-angled hover:bg-ember flex items-center justify-center gap-2", children: [_jsx(Ticket, { size: 18 }), "Buy ", quantity, " Ticket", quantity > 1 ? 's' : ''] })] })] })] }));
}
