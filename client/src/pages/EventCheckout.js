...
export default function EventCheckout() {
    ...
    if (loading) {
        return (_jsx("div", { className: `${pageRoot} flex items-center justify-center`, children: _jsx(Loader, { className: "w-12 h-12 animate-spin text-fire" }) }));
    }
    if (error && !event) {
