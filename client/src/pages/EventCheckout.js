    ...
    useEffect(() => {
        const fetchEvent = async () => {
            try {
                ...
                const fromState = types.find((t) => t.id === initialTypeId);
                const firstAvailable = (fromState && !fromState.is_sold_out ? fromState : null) ||
                    types.find((t) => !t.is_sold_out) ||
                    null;
