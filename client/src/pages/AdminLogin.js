...
const STAFF_ROLES = ['admin', 'scanner'];
export default function AdminLogin() {
    ...
    const defaultPathForRole = (role) => (role === 'scanner' ? '/admin/scan' : '/admin');
