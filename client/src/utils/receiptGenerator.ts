...
export function generateReceiptText(data: PaymentHistoryItem | ReceiptData): string {
...
export function downloadReceiptAsText(data: PaymentHistoryItem | ReceiptData): void {
...
export function downloadReceiptAsCSV(
  payments: (PaymentHistoryItem | ReceiptData)[]
): void {
...
export function formatReceiptData(data: ReceiptData): {
  title: string
