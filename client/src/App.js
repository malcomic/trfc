...
function TikTokPixelTracker() {
    ...
    useEffect(() => {
        ...
        const lastGlobalPage = window.__ttq_last_page;
        // Guard against React 18 StrictMode double-invoking effects in development.
        if (lastGlobalPage === page || lastPageRef.current === page)
            return;
        lastPageRef.current = page;
        window.__ttq_last_page = page;
        window.ttq?.page?.();
