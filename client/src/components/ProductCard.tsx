...
export default function ProductCard({ product, variant = 'full' }: { product: Product; variant?: 'full' | 'compact' }) {
  ...
  return (
<<<<<<< HEAD
    <div className="group relative flex flex-col h-full bg-night-light dark:bg-ash border border-ash-light dark:border-mist hover:border-fire/30 dark:hover:border-fire/30 transition-all duration-300 hover:shadow-lg hover:scale-[1.01]">

      {/* Left fire accent line */}
      <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-fire scale-y-0 group-hover:scale-y-100 origin-bottom transition-transform duration-300 ease-out z-10" />

      {/* ── Image ── */}
      <div className="relative overflow-hidden aspect-square bg-ash-light dark:bg-smoke flex-shrink-0">
=======
...
<<<<<<< HEAD
            <Package size={40} className="text-fire/15" />
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
        ...
        {isNew && !isSoldOut && (
<<<<<<< HEAD
          <span className="absolute top-3 left-3 bg-fire text-chalk font-barlow-condensed font-black text-[10px] tracking-[2px] uppercase px-2.5 py-1 z-10">
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
        ...
        {isSoldOut && (
<<<<<<< HEAD
          <span className="absolute top-3 left-3 bg-smoke text-fog font-barlow-condensed font-black text-[10px] tracking-[2px] uppercase px-2.5 py-1 border border-mist z-10">
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
        ...
        {prod.category && (
<<<<<<< HEAD
          <span className="absolute top-3 right-3 flex items-center gap-1 bg-black/70 backdrop-blur-sm text-fog font-barlow-condensed font-bold text-[9px] tracking-[2px] uppercase px-2 py-1 border border-white/08 z-10">
            <Tag size={8} className="text-fire" />
=======
...
<<<<<<< HEAD
      {/* ── Body ── */}
      <div className="flex flex-col flex-1 px-4 pt-4 pb-5 border-t border-ash-light dark:border-mist gap-1.5">

        {/* Name */}
        <h3 className="font-barlow-condensed font-bold text-[17px] tracking-[0.3px] text-chalk-light dark:text-chalk leading-snug">
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
        ...
        {prod.description && (
<<<<<<< HEAD
          <p className="text-[12px] text-chalk-light/60 dark:text-fog leading-relaxed line-clamp-2 mt-0.5">
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
        ...
        {typeof prod.stock === 'number' && prod.stock > 0 && prod.stock <= 5 && (
<<<<<<< HEAD
          <p className="font-barlow-condensed font-bold text-[10px] tracking-[2px] uppercase text-fire mt-1">
=======
...
<<<<<<< HEAD
        {/* Price row */}
        <div className="flex items-end justify-between pt-3 border-t border-ash-light dark:border-mist mt-2">
          <div>
            <p className="font-bebas text-[28px] text-fire leading-none tracking-wide">
              KES {Number(prod.price).toLocaleString()}
            </p>
            {prod.original_price && prod.original_price > prod.price && (
              <p className="text-[11px] text-fog line-through leading-none mt-0.5">
=======
...
>>>>>>> ae707d8c0a73e5527b29afbb8289c6a4bfcd1793
          ...
          {prod.original_price && prod.original_price > prod.price && (
<<<<<<< HEAD
            <span className="font-barlow-condensed font-black text-[11px] tracking-[1px] uppercase bg-fire/10 border border-fire/25 text-fire px-2 py-1">
=======
