...
export default function PaymentStatusModal({ isOpen, checkoutRequestId, phone, onClose, }) {
    ...
    if (!isOpen)
        return null;
    return (_jsx("div", { className: "fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50", children: _jsxs("div", { className: "bg-ash light:bg-ash-light border border-white/10 light:border-black/10 clip-angled-sm shadow-lg max-w-md w-full font-barlow", children: [_jsxs("div", { className: "bg-accent light:bg-accent-light text-black light:text-white px-6 py-5 border-b border-white/10 light:border-black/10", children: [_jsx("h2", { className: "font-bebas text-3xl leading-tight", children: "PAYMENT STATUS" }), _jsx("p", { className: "font-barlow-condensed text-xs tracking-widest uppercase text-black/70 light:text-white/80 mt-1", children: "M-Pesa transaction" })] }), _jsxs("div", { className: "p-6 text-chalk light:text-chalk-light", children: [status === 'pending' && (_jsxs("div", { className: "text-center", children: [_jsx(Loader, { className: "w-14 h-14 text-accent light:text-accent-light animate-spin mx-auto mb-4" }), _jsx("p", { className: "font-barlow-condensed font-bold text-lg tracking-tighter mb-2", children: "Waiting for Confirmation" }), _jsx("p", { className: "text-fog text-sm mb-4", children: "We're waiting for payment confirmation on" }), _jsx("div", { className: "bg-smoke border border-white/10 p-3 mb-4 font-mono text-sm font-semibold break-all text-chalk", children: phone }), _jsx("p", { className: "text-xs text-fog", children: "Check your phone for the M-Pesa prompt. Enter your PIN to complete the transaction." }), _jsx("p", { className: "mt-6 text-sm text-fog", children: "This window will close automatically once payment is confirmed." })] })), status === 'success' && (_jsxs("div", { className: "text-center", children: [_jsx(CheckCircle, { className: "w-14 h-14 text-green-400 mx-auto mb-4" }), _jsx("p", { className: "font-barlow-condensed font-bold text-lg tracking-tighter mb-2", children: "Payment Successful!" }), _jsx("p", { className: "text-fog text-sm mb-4", children: "Your order has been confirmed." }), _jsxs("div", { className: "bg-green-500/10 border border-green-500/25 p-4 text-sm text-green-300", children: [_jsx("p", { className: "font-semibold", children: "Transaction Confirmed" }), _jsx("p", { className: "text-xs mt-1 text-fog", children: "You will receive a confirmation email shortly." })] })] })), status === 'failed' && (_jsxs("div", { className: "text-center", children: [_jsx(AlertCircle, { className: "w-14 h-14 text-red-400 mx-auto mb-4" }), _jsx("p", { className: "font-barlow-condensed font-bold text-lg tracking-tighter mb-2", children: "Payment Failed" }), _jsx("p", { className: "text-fog text-sm mb-4", children: error }), _jsx("div", { className: "bg-red-500/10 border border-red-500/20 p-4 text-sm text-red-300", children: _jsx("p", { children: "Please try again or contact support for assistance." }) })] }))] }), _jsx("div", { className: "border-t border-white/10 px-6 py-4 bg-night/50", children: status !== 'pending' && (_jsx("button", { onClick: onClose, className: "w-full bg-accent light:bg-accent-light text-black light:text-white px-4 py-3 font-barlow-condensed font-black text-sm tracking-widest uppercase clip-angled hover:bg-accent/90 light:hover:bg-accent-light/90 transition-colors duration-200", children: "Close" })) })] }) }));
}
