...
export default function PrivateRoute({ children, role, loginPath = '/login' }) {
    ...
    if (isLoading) {
        return (_jsx("div", { className: "flex items-center justify-center h-screen bg-night light:bg-night-light text-chalk font-barlow", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "animate-spin rounded-full h-10 w-10 border-b-2 border-accent light:border-accent-light mx-auto mb-3" }), _jsx("p", { className: "font-barlow-condensed font-bold text-xs tracking-widest uppercase text-fog", children: "Loading\u2026" })] }) }));
    }
    if (!token) {
