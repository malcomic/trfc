...
export default function TicketDownloadButton({ ticketId, paymentStatus, eventTitle = 'Event Ticket', className = '', verify, compact = false, }) {
    ...
    return (_jsxs("div", { className: className, children: [_jsx("button", { type: "button", onClick: handleDownload, disabled: isLoading || !isDownloadable, className: `
        ...
        `, title: !isDownloadable
                    ...
                    : `Download ${eventTitle} ticket`, children: isLoading ? (_jsxs(_Fragment, { children: [_jsx(Loader, { className: "h-3.5 w-3.5 animate-spin" }), "Downloading\u2026"] })) : success ? (_jsxs(_Fragment, { children: [_jsx(Check, { className: "h-3.5 w-3.5" }), "Downloaded"] })) : (_jsxs(_Fragment, { children: [_jsx(Download, { className: "h-3.5 w-3.5" }), "Download PDF"] })) }), error && _jsx("p", { className: "mt-2 text-sm text-red-400", children: error })] }));
}
